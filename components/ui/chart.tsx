...
// Simplified helper types (safe across Recharts versions)
...
interface CustomTooltipProps extends React.HTMLAttributes<HTMLDivElement> {
  active?: boolean;
