...
import { ArrowRight, Sparkles, Zap, Bot, Calendar, Clock, Users, Star, Play, CheckCircle } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-6 sm:space-y-8 lg:space-y-12">
            ...
            <div className="pt-8 sm:pt-12">
              <Card className="max-w-4xl mx-auto border-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl shadow-2xl overflow-hidden">
                <CardContent className="p-0">
                  <div className="relative aspect-video bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center">
                    <div className="text-center text-white">
                      ...
                      <h3 className="text-xl font-semibold mb-2">Watch Workshop Preview</h3>
                      <p className="text-blue-100">See what you'll learn in 3 hours</p>
                    </div>
                  </div>
                  <div className="p-6 bg-white dark:bg-gray-900">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                      ...
                      <div className="flex items-center justify-center gap-2">
                        <CheckCircle className="w-5 h-5 text-green-500" />
                        <span className="text-sm font-medium">Interactive Q&A</span>
                      </div>
                      <div className="flex items-center justify-center gap-2">
                        <CheckCircle className="w-5 h-5 text-green-500" />
