...
import { SiZapier, SiN8N, SiMake } from "react-icons/si";
...
// const iconConfigs = [
//   { Icon: SiZapier, color: "#ff4d00" },
//   { Icon: SiN8N, color: "#FF9900" },
...
const iconConfigs = [
  { Icon: SiZapier, color: "#ff4d00" }, // Zapier
  { Icon: SiN8N, color: "#FF9900" }, // n8n
  { Icon: SiMake, color: "#764ABC" }, // Make.com
  { Icon: FaTwitter, color: "#1DA1F2" },
  { Icon: FaLinkedin, color: "#0077B5" },
  { Icon: FaInstagram, color: "#E1306C" },
  { Icon: FaGoogle, color: "#DB4437" },
