    ...
    <section ref={sectionRef} className="py-12 sm:py-20  ">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mx-auto">
          <Card
            ref={cardRef}
            className="border-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl shadow-2xl hover:shadow-3xl transition-all duration-500 overflow-hidden"
          >
            {/* Gradient header */}
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-center justify-center space-x-4">
                      ...
                      <div className="text-left">
                        <span className="text-xl sm:text-2xl text-gray-500 line-through block">
                          ₹2,999
                        </span>
            ...
            <CardContent className="p-6 sm:p-8 space-y-6 sm:space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {features.map((feature, index) => (
                  <div
                    key={index}
                    className="pricing-feature flex items-center text-gray-700 dark:text-gray-300"
                  >
              ...
              <div className="space-y-3 sm:space-y-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 sm:p-6">
                ...
                <div className="flex items-center justify-center">
                  <Badge
                    variant="outline"
                    className="border-orange-300 text-orange-600 dark:border-orange-700 dark:text-orange-400 px-3 py-1"
                  >
