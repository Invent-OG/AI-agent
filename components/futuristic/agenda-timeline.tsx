...
const agendaItems = [
  ...
  },
  {
    ...
    description:
      "Build your first automation workflow live with real business scenarios",
    duration: "45 min",
    type: "hands-on",
  },
  {
    ...
    description:
      "Advanced visual automation techniques and custom node creation",
    duration: "45 min",
    type: "advanced",
  },
  {
    ...
    description:
      "Complex multi-step automation setup and enterprise integrations",
    duration: "45 min",
    type: "expert",
  },
  {
    ...
    description:
      "Live questions, bonus templates, and course enrollment opportunities",
    duration: "15 min",
    type: "bonus",
  },
];
...
export function AgendaTimeline() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-12 sm:py-20 bg-gradient-to-br from-gray-950 via-blue-950/20 to-indigo-950/20 relative"
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            3 hours of intensive, hands-on automation training with live
            demonstrations
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-12 sm:mb-16">
          {workshopInfo.map((info, index) => (
            <Card
              key={info.title}
              className="info-card group hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 border-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm"
            >
              <CardContent className="p-4 sm:p-6 text-center">
                <div
                  className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br ${info.color} rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                >
                      ...
                      <CardContent className="p-4 sm:p-6 lg:p-8">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <Badge
                              className={`${getTypeColor(item.type)} text-xs font-medium`}
                            >
          ...
          <Card className="max-w-2xl mx-auto border-0 bg-gradient-to-r from-blue-600 to-purple-600 shadow-2xl">
            <CardContent className="p-6 sm:p-8 text-center text-white">
              ...
              <p className="text-blue-100 mb-4 sm:mb-6 text-sm sm:text-base">
                Join hundreds of successful entrepreneurs who&apos;ve automated
