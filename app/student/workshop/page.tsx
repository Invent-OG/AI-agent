...
export default function StudentWorkshopPage() {
  ...
  const isRegistered = student?.workshopStatus === "registered" || student?.status === "paid";
          ...
          <CardContent className="p-8">
            {isRegistered ? (
              ...
              <div className="text-center">
                ...
                >
                  {registerForWorkshop.isPending ? "Processing..." : "Register for ₹499"}
                </Button>
              </div>
            )}
          </CardContent>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900 dark:text-white">10:00 AM - 1:00 PM</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Duration</p>
                    <p className="font-semibold text-gray-900 dark:text-white">3 Hours</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Format</p>
                    <p className="font-semibold text-gray-900 dark:text-white">Live Online</p>
                  </div>
                </div>
                
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">What you'll learn:</p>
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                  <div className="flex items-center justify-center text-orange-600 dark:text-orange-400">
                    ...
                    <span className="text-sm font-medium">Only 28 seats remaining!</span>
                  </div>
                </div>
              </div>
            </CardContent>
