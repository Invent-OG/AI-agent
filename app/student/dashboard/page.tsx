          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="dashboard-card border-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">
                    {Math.floor((progressData?.totalWatchTime || 0) / 3600)}h {Math.floor(((progressData?.totalWatchTime || 0) % 3600) / 60)}m
                  </p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Learning time
                  </p>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {progressData?.recentActivity?.map((activity: any, index: number) => (
                      <div key={index} className="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card className="border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-200">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="font-semibold text-gray-900 dark:text-white mb-2">General Discussion</h3>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Share ideas and connect with peers</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-200">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Technical Help</h3>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Get help with automation challenges</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-200">
                      <CardContent className="p-6 text-center">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">Share your automation wins</p>
                      </CardContent>
                    </Card>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      {[1, 2, 3].map((i) => (
                        <div key={i} className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors cursor-pointer">
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                                Looking for best practices to automate our customer onboarding process...
                              </p>
                            ...
                            <Badge variant="outline" className="ml-4">Technical</Badge>
                          </div>
                        </div>
                      ))}
                    </div>
