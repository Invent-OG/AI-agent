            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white">Peak Hours</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Most active time</p>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white">Top Location</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Highest engagement</p>
                  </div>
